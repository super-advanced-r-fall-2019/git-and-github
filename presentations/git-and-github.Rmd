...
1. What does this repo's `.gitignore` file look like?

1. Ignore all the `.csv`, `.Rdata`, and `.rds` files inside the results folder
...
background-image: url("../imgs/Conflict.png")
background-size: 400px
background-position: 90% 20%
...
In this conflict, the lines between <<<<<< HEAD:my-file.R and ====== are the content from the branch you are currently on. The lines between ======= and >>>>>>> issue-5:my-file.R are from the feature branch we are merging. 
...
4. Merge changes in feature branch back into the master branch
...
1. Go back to your branch and [rebase](https://hackernoon.com/git-merge-vs-rebase-whats-the-diff-76413c117333) from `master`
