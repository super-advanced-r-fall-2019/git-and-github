...
Create a new feature branch: `git checkout -b my-new-feature-branch`
...
Jump back to master branch: `git checkout master`

Merge change into master: `git merge my-new-feature-branch`

--

\* Useful when developing and testing features that won't mess up the main line.


---

# How to Git (with a remote repository and branching)
...
.center[***`git help`*** or ***`git help <verb>`*** or ***`git <verb> -h`***]
